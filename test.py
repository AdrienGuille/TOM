...
corpus = Corpus(source_file_path='input/rss.csv',
                ...
                preprocessor=EnglishStemmer())  # determines how documents are preprocessed (e.g. stemming, lemmatization)
...
# Infer topics
topic_model.infer_topics(num_topics=20)  # 20 topics
